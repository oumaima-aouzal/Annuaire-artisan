...
<div class="row">
<div class="col-sm-12">
<h3 class="page-title">Gestion des Départements</h3>
...
<thead>
	<button type="button" class="btn btn-default btn-sm" style="margin-left: 900px; background-color: #5f4be2;color: aliceblue; float: right; " onclick="tst();">
...
<td>
<h2 class="table-avatar">
<a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset('admin\assets\img\user\user6.jpg')}}" alt="User Image"></a>
...
<td>
<h2 class="table-avatar">
<a href="profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="{{asset('admin\assets\img\user\user9.jpg')}}" alt="User Image"></a>
