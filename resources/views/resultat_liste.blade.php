...
<div class="main-wrapper map-page">
   ...
   <section class="section path-section" style=" padding-bottom: 00px">
                           ...
                           <div class="row align-items-center mb-4">
                                 ...
                                 <div class="col-md-6 col load-more text-center">
                                        <div class="view-icons">
                                           <a href="{{url('/resultat')}}" class="grid-view "><i class="fas fa-th-large"></i></a>
                                           <a href="{{url('/resultat_list')}}" class="list-view active "><i class="fas fa-bars"></i></a>
                                        </div>
                                         <div class="sort-by">
   ...
   <div class="card">
           <div class="card-body">
               ...
               <h4 class="usr-name"><a href="{{url('/profile')}}">Paul Richard</a></h4>
               <p class="mentor-type">UNIX</p>
                   <div class="rating">
            ...
            <div class="user-info-right">
                 ...
                 <a class="apt-btn" onclick="document.getElementById('id01').style.display='block'">Devis</a>
                 </div>
            </div>
               </div>
           </div>
   ...
   <br><br><br>
       ...
       <a class="btn btn-primary btn-sm" href="javascript:void(0);" style="width: 200px; height: 35px; text-align: center; font-size: 15px;border: none; background-color:#757575;">Cherche </a>
              ...
              {{-- RECOMMENDATION --}}
              <div class="col-xl-8 col-lg-12 order-md-last order-sm-last order-last map-left mx-auto">
                <div class="row align-items-center mb-4">
                      <div class="col-md-6  ">
